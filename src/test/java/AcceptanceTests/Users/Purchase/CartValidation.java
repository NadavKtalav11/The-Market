...
//        impl.init(new UserDTO("KobiM","","","","","",""), "123", "27/4/95", "Israel", "Beer Sheva", "Mesada", "kobi Menashe", 1, "payementService", "kobi@gmail.com", 2, "supplyService", countries, cities);
//        impl.enterMarketSystem();
